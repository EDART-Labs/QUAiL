...
| **[QUAiL Beta v2.0.0](https://github.com/saket-sontakke/QUAiL-A-Qualitative-Data-Analysis-Application/blob/e056ad53f033cec5fd65647b295a1d1f5ac1e619/QUAiL%20Developer%20Guide%20%5BBeta%20v2.0.0%5D.pdf)** | 27-Dec-25 | - Added missing current project's **Coded Segments Export Route**. <br> - Fixed **Multi-tab Desynchronization** problem <br> -Enhanced Edit Mode with **File-Level Tab Locking** and **Intermediate Saves**. <br> - Implemented Automated **Janitor** and **Deep Clean** Scripts for disk cleanup. <br> -Upgraded **Memos** to **Draggable** pop-ups. <br> - Added **Delete Account** feature, **Privacy Policy** page, and **ICCE 2025 Paper** page. | Unreleased |
